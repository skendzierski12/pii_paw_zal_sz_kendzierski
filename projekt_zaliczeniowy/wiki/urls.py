...
urlpatterns = [
        path('api/continents/', views.continent_list),
        path('api/locations/', views.location_list),
        path('api/races/', views.race_list),
        path('api/guilds/', views.guild_list),
        path('api/kingdoms/', views.kingdom_list),
        path('api/epicentres/', views.epicentre_list),
        path('api/items/', views.item_list),

        path('api/continents/<int:pk>/', views.continent_detail),
        path('api/locations/<int:pk>/', views.location_detail),
        path('api/races/<int:pk>/', views.race_detail),
        path('api/guilds/<int:pk>/', views.guild_detail),
        path('api/kingdoms/<int:pk>/', views.kingdom_detail),
        path('api/items/<int:pk>/', views.item_detail),
        path('api/plague/', views.plague_detail),
